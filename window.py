...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionorderFileCombine.setText(_translate("MainWindow", "求空结果分组交并处理"))
        self.actionfiveEmptyBindInter.setText(_translate("MainWindow", "前五后五求空交并"))
        self.actionshaCodeFullCha.setText(_translate("MainWindow", "杀码满集差集组合运算"))
